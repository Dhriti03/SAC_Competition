...
if("TRUE" STREQUAL "TRUE")
  set(live_demo_SOURCE_PREFIX /home/dhriti/sac_ws/src/live_demo)
  set(live_demo_DEVEL_PREFIX /home/dhriti/sac_ws/devel)
  ...
  set(live_demo_INSTALL_PREFIX /home/dhriti/sac_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'dhriti <dhriti@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'live_demo' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'live_demo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dhriti/sac_ws/src/live_demo/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT live_demo_NUM_DUMMY_TARGETS)
      set(live_demo_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::live_demo::wrapped-linker-option${live_demo_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR live_demo_NUM_DUMMY_TARGETS "${live_demo_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::live_demo::wrapped-linker-option${live_demo_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND live_demo_LIBRARIES "${interface_target_name}")
...
set(live_demo_EXPORTED_TARGETS "")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${live_demo_dep}_FOUND)
      find_package(${live_demo_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${live_demo_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(live_demo_EXPORTED_TARGETS ${${live_demo_dep}_EXPORTED_TARGETS})
endforeach()
